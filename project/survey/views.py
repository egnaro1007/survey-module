    ...
    def get(self, request):
        ...
        if survey.active:
            ...
            for question in questions:
                ...
                questions_list[question.order] = question_data
    ...
    def post(self, request):
        ...
        if Survey.objects.filter(id = survey_id).exists():
            ...
            if survey.active == True:
                ...
                return Response({'message': 'This survey is not recieving responses.'}, status=status.HTTP_400_BAD_REQUEST)
    ...
    def post(self, request):    
        ...
        if survey:
            ...
            if question.type in ['text', 'multi', 'single']:
                ...
                return Response({'message': 'Question must be text, multi, single', 'code': 400}, status=status.HTTP_400_BAD_REQUEST)
...
class RenameSurvey(APIView):
    ...
    def put(self, request):
        ...
        if survey:
            ...
            survey.save()
            return Response({'message': 'success', 'survey_id': survey_id, 'new_title': new_title}, status=status.HTTP_200_OK)
        else :
